...
dash.register_page(__name__, name='Desmatamento Mapa AM')
...
def servidor_layout():
    return  html.Div(children=[
                    dbc.Container(dbc.Alert(html.H5("Desmatamento estado: AM (período 7 dias)", 
