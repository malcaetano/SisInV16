...
dash.register_page(__name__, name='Queimadas Mapa MT')
...
def servidor_layout():
    return  html.Div(children=[
                    dbc.Container(dbc.Alert(html.H5("Queimadas estado: MT (últimos 7 dias)", 
