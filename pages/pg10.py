...
dash.register_page(__name__, name='Desmatamento Geral')

   

kw_list=['desmatamento']
teste = pd.read_excel('google2.xlsx')
...
fig1 = px.line(teste,x='horas',y='desmatamento')
...
fig2 = px.histogram(difer1,nbins=5,color_discrete_sequence=['green'])
...
layout = html.Div(children=[
    dbc.Container(dbc.Alert(html.H5("Situação do Desmatamento (últimos 7 dias)", className="alert-heading"), color="info"),
    className="m-2"),
