...
dash.register_page(__name__, name='Desmatamento Mapa PR')
...
def atualiza_fig2():
    ...
    interesse=pd.read_excel('Regiao_PR.xlsx')
    altura_pico = 40
...
def servidor_layout():
    return  html.Div(children=[
                    html.Div("designed by students Cauê Renantini, Rodrigo Paz Freitas Junior, Valter Rebelo", 
                             style={'fontSize':10, 'textAlign':'left',
                                                                    'font-weight': 'bold',
                                                                    'color':'white',
                                                                    'font-style':'italic'}),
                    dbc.Container(dbc.Alert(html.H5("Desmatamento estado: PR (período 7 dias)", 
