...
dash.register_page(__name__, name='Queimadas Mapa RJ')
...
def servidor_layout():
    return  html.Div(children=[
                    dbc.Container(dbc.Alert(html.H5("Queimadas estado: RJ (últimos 7 dias)", 
